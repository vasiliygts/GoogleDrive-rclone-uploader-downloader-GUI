...
профіль. Прапорці й кількість потоків спільні на всю чергу, тому один запуск
не може мати різні налаштування для різних файлів — потрібні саме два прогони.

Робити це вручну не обов'язково. Тип **«Суміш · два проходи — швидше»**
бере це на себе: складаєш чергу один раз, тиснеш Старт — і програма сама
